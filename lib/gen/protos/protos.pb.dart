...
class StateChange extends $pb.GeneratedMessage {
  ...
  StateChange copyWith(void Function(StateChange) updates) =>
      super.copyWith((message) => updates(message as StateChange))
          as StateChange; // ignore: deprecated_member_use
...
class WifiP2pDevice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'wpsPbcSupported',
        protoName: 'wpsPbcSupported')
    ..aOB(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'wpsKeypadSupported',
        protoName: 'wpsKeypadSupported')
    ..aOB(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'wpsDisplaySupported',
        protoName: 'wpsDisplaySupported')
    ..aOB(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'deviceName',
        protoName: 'deviceName')
    ..aOS(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'deviceAddress',
        protoName: 'deviceAddress')
    ..aOS(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'primaryDeviceType',
        protoName: 'primaryDeviceType')
    ..aOS(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'secondaryDeviceType',
        protoName: 'secondaryDeviceType')
    ..e<WifiP2pDevice_Status>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'status',
  ...
  WifiP2pDevice copyWith(void Function(WifiP2pDevice) updates) =>
      super.copyWith((message) => updates(message as WifiP2pDevice))
          as WifiP2pDevice; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WifiP2pDeviceList extends $pb.GeneratedMessage {
  ...
  WifiP2pDeviceList copyWith(void Function(WifiP2pDeviceList) updates) =>
      super.copyWith((message) => updates(message as WifiP2pDeviceList))
          as WifiP2pDeviceList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConnectionChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<WifiP2pInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'wifiP2pInfo',
        protoName: 'wifiP2pInfo',
        subBuilder: WifiP2pInfo.create)
    ..aOM<NetworkInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'networkInfo',
        protoName: 'networkInfo',
  ...
  ConnectionChange copyWith(void Function(ConnectionChange) updates) =>
      super.copyWith((message) => updates(message as ConnectionChange))
          as ConnectionChange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WifiP2pInfo extends $pb.GeneratedMessage {
  ...
  WifiP2pInfo copyWith(void Function(WifiP2pInfo) updates) =>
      super.copyWith((message) => updates(message as WifiP2pInfo))
          as WifiP2pInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'isConnected',
        protoName: 'isConnected')
    ..e<NetworkInfo_DetailedState>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'detailedState',
...
class RequestPermissionResult extends $pb.GeneratedMessage {
  ...
  RequestPermissionResult copyWith(
      ...
      super.copyWith((message) => updates(message as RequestPermissionResult))
          as RequestPermissionResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SocketMessage extends $pb.GeneratedMessage {
  ...
  SocketMessage copyWith(void Function(SocketMessage) updates) =>
      super.copyWith((message) => updates(message as SocketMessage))
          as SocketMessage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DiscoveryStateChange extends $pb.GeneratedMessage {
  ...
  DiscoveryStateChange copyWith(void Function(DiscoveryStateChange) updates) =>
      super.copyWith((message) => updates(message as DiscoveryStateChange))
          as DiscoveryStateChange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WifiP2pGroup extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $core.bool get isGroupOwner => $_getBF(5);
  @$pb.TagNumber(6)
  set isGroupOwner($core.bool v) {
    $_setBool(5, v);
  }
  ...
  @$pb.TagNumber(6)
  $core.bool hasIsGroupOwner() => $_has(5);
  @$pb.TagNumber(6)
  void clearIsGroupOwner() => clearField(6);

  @$pb.TagNumber(7)
  WifiP2pDevice get owner => $_getN(6);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  WifiP2pDevice ensureOwner() => $_ensure(6);
